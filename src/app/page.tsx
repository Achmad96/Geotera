...
export default function HomePage() {
    return (
        <main className="h-auto">
            <section className="flex w-full h-[90dvh] items-center justify-center max-xl:justify-around max-lg:flex-col-reverse max-lg:pt-10">
                <ToastContainer />
                <div className="flex flex-col gap-5 pt-5 max-sm:ml-5  ">
                    ...
                    <div className="flex flex-col gap-5 pb-24">
                        ...
                        <svg
                            ...
                            viewBox="0 0 370 191"
                            fill="none"
                            className="absolute left-0 bottom-7 -z-10 max-lg:w-56 max-lg:h-60 max-xl:collapse"
                        >
                            <path
                ...
                <Image src={Vector} alt="Vector" priority className="mb-16 w-[35rem] h-[35rem] max-xl:w-[30rem] max-xl:h-[30rem] max-lg:w-80 max-lg:h-80 max-sm:w-64 max-sm:h-64" />
