...
export default function Home() {
    return (
        <main className="flex flex-col items-center h-auto w-full max-w-full ">
            <ToastContainer />
            <OrderModal />
            <section id="#home" className="flex w-full max-w-full h-[90vh] items-center justify-center max-xl:justify-around max-lg:flex-col-reverse max-lg:pt-10 overflow-x-hidden">
            ...
            <section id="about" className="flex justify-center items-center w-full max-w-full h-[90vh] overflow-x-hidden">
                <AnimatedText
