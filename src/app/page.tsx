...
export default function Home() {
  return (
    <main className="flex flex-col items-center h-auto w-full max-w-full">
      ...
      <section
        id="#home"
        className="flex w-full max-w-full h-[90svh] items-center justify-center max-xl:justify-around max-lg:flex-col-reverse max-lg:pt-10"
      >
        <div className="flex flex-col gap-5 pt-5 max-sm:ml-5">
          <p className="text-4xl w-[30rem] font-bold max-lg:text-3xl max-sm:text-xl max-sm:w-80 ">
            Geotera, Clean Solution for Your{" "}
            <span className="text-[#2FBC9B]">Healthy</span> Environment!
          </p>
          <div className="flex flex-col gap-5 pb-24">
            <div className="flex flex-col gap-3">
              <h2 className="text-base text-justify tracking-wider w-[25rem] max-sm:w-72">
            ...
            <svg
              ...
              viewBox="0 0 370 191"
              fill="none"
              className="absolute left-0 bottom-3 -z-10 max-lg:w-56 max-lg:h-60 max-xl:collapse"
            >
              <path
        ...
        <Image
          ...
          alt="Vector"
          priority
          className="-z-10 mb-16 w-[35rem] h-[35rem] max-xl:w-[30rem] max-xl:h-[30rem] max-lg:w-80 max-lg:h-80 max-sm:w-64 max-sm:h-64"
        />
        <svg
          className="absolute right-0 -z-20 max-xl:collapse"
          xmlns="http://www.w3.org/2000/svg"
          width="850"
          height="970"
          viewBox="0 0 850 970"
      ...
      <section
        id="about"
        className="flex justify-center items-center w-full max-w-full h-svh"
      >
        <AnimatedText
