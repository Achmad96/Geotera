...
export default function Home() {
    return (
        <main className="flex flex-col items-center h-auto">
            <ToastContainer />
            <OrderModal />
            <section id="#home" className="flex w-full h-[90dvh] items-center justify-center max-xl:justify-around max-lg:flex-col-reverse max-lg:pt-10">
            ...
            <section id="about" className="flex justify-center items-center w-full h-[100dvh] ">
                <AnimatedText
