...
export default function ({
  ...
  return (
    <button
      ...
      className={`text-md w-full pl-3 text-left hover:bg-neutral-200 focus:bg-neutral-200 focus:outline-none max-lg:text-sm max-sm:pl-2 max-sm:text-xs suggest-${index}`}
    >
      {location.name}
    </button>
  );
