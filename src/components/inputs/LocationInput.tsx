...
const LocationInput = ({
  ...
  return (
    <div className="relative flex w-full flex-col justify-start gap-5">
      <p>Location</p>
      <input
        name="location"
        type="text"
        ...
        className="h-10 w-[90%] border-b pl-2 outline-none max-sm:text-sm"
        required
      />
      <div
        className={"absolute w-[80%] bg-white hover:cursor-pointer"}
        style={{
